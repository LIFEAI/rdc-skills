...
```
skills/
  architecture-reviewer/SKILL.md (layering and dependency-direction review)
  ...
  clean-code-analyzer/SKILL.md (naming, dead code and complexity smells)
  ...
  pattern-refactoring-guide/SKILL.md (a finding turned into a step-ordered plan)
  ...
  solid-validator/SKILL.md (deterministic SOLID and Clean Architecture scoring)
  status/SKILL.md      (project dashboard)
  terminal-config/SKILL.md (Windows Terminal and hidden-launch policy)
  testing-strategy/SKILL.md (test level and shape recommendations)
