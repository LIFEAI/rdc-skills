---
name: rdc:setup
description: Intelligent project setup — scan existing files, detect config, generate .rdc/config.json and overlay guides
user-invocable: true
---
...
```bash
git add .rdc/
git commit -m "feat(rdc): add .rdc/config.json and overlay guides
